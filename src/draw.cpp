...
private:
    ...
    void sfusion_publishDrawing_callback()
    {
        ...
        makeMeshMarker(marker1, 0, 0, 0, 0, 0.005, 0.0, M_PI, 
        ...
        makeMeshMarker(marker2, 1, 5, 0, 0, 0.5, 0.0, 0.0,  
        ...
        makeMeshMarker(marker3, 2, -5, 0, 0, 0.005, 0.0, M_PI, 
        ...
        makeMeshMarker(marker4, 3, 10, 0, 0, 0.8, M_PI/2, M_PI, 
        ...
        makeMeshMarker(marker5, 4, -10, 0, 0, 0.5, 0.0, M_PI,
    ...
    void makeMeshMarker(visualization_msgs::msg::Marker &marker, const int id,  const float x, const float y, const float z, const float scale, const float angleOffset, const float yawOffset, const std::string& mesh_path)
    {
        ...
        orientation.setRPY(angleOffset, 0.0, angle + yawOffset);
